...
function Footer() {
  ...
  return (
    ...
    >
      <div className="flex flex-wrap lg:flex-nowrap w-full border-blue-200 p-2 rounded-3xl mb-2 border-b-2 justify-center">
        <div className="m-4 w-3/12 min-w-max">
          <h1 className="text-3xl font-serif mb-5 text-center">Sitemap</h1>
        ...
        <div className="m-4 w-3/12 min-w-max">
          <h1 className="text-3xl text-center font-serif mb-5">Our Services</h1>
          <ul className="flex flex-col justify-center text-xl text-slate-200">
            ...
            <li className="mb-6 hover:border hover:p-4">
              {rightArrow} Recruitment of registered nurses
            </li>
          </ul>
        </div>
        <div className="m-4 w-3/12 min-w-max">
          <h1 className="text-3xl text-center mb-5 font-serif">Quick Links</h1>
